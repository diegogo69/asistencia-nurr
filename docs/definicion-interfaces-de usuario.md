...
- **Definición de Componentes y Flujo Funcional:**
  - **Barra de Herramientas Superior:**
    - **Botón** Agregar Unidad**:** Despliega una ventana emergente (_Modal_) para la creación de una unidad.
    - **Campo/Filtro** Filtrar**:** Entrada de texto y selectores para la búsqueda dinámica en tiempo real por nombre o tipo de unidad (_Dirección_, _Coordinación_, _Sección_, _Oficina_).
...
- **Definición de Componentes y Flujo Funcional:**
  - **Barra de Herramientas Superior:**
    ...
    - **Campo/Filtro** Filtrar**:** Permite realizar búsquedas por el nombre de la plantilla o el tipo (_Fijo_ o _Flexible_).
  - **Tabla de Visualización de Registros:**
  ...
  - **Ventana Emergente (Modal)** Formulario de Plantilla de Horarios**:**
    - **Campos Principales:** Campo de texto para Nombre de Plantilla, selector para Tipo (_Fijo_ / _Flexible_) y campo numérico para Horas Requeridas Semanales (activado para horarios flexibles de pasantes).
...
- **Definición de Componentes y Flujo Funcional:**
  ...
  - **Interfaz / Componente Servidor (Proceso Automático):**
    - Componente no visual que intercepta las peticiones de marcación y retorna alertas de bloqueo ("_Dispositivo fuera del rango de red autorizado_") en la pantalla de marcación del cliente si la IP no pertenece a las reglas activas.
...
- **Definición de Componentes y Flujo Funcional:**
  ...
  - **Ventana Emergente (Modal)** Formulario de Gestión de Usuarios**:**
    ...
    - **Campo Condicional:** Campo Contraseña (se habilita automáticamente si el rol seleccionado requiere acceso administrativo: requiere_password \= true).
    - **Controles de Acción:**
...
- **Definición de Componentes y Flujo Funcional:**
  - **Evento al Perder el Foco (_OnBlur_) / Evento al Guardar:**
  ...
  - **Mecanismo de Respuesta Visual en la Interfaz:**
    ...
    - **Mensaje de Alerta Integrado:** Despliegue de un texto o banner informativo de error ("_El documento de identidad ingresado ya se encuentra registrado en la plataforma_").
...
- **Definición de Componentes y Flujo Funcional:**
  - **Panel de Captura de Vídeo:**
    - **Componente de Vista Previa (_Webcam View_):** Recuadro que proyecta la señal en vivo de la cámara web.
  ...
  - **Retroalimentación del Sistema:**
    - Mensajes de estado en tiempo real ("_Cámara no detectada_", "_Rostro no detectado correctamente_", "_Patrón biométrico facial registrado correctamente_").
...
- **Definición de Componentes y Flujo Funcional:**
  ...
  - **Controles de Acción:**
    - **Botón** Iniciar Sesión**:** Envía la solicitud para validar las credenciales, verificar la clave encriptada y comprobar que el rol tenga privilegios administrativos (requiere_password \= true).
...
- **Módulo de Presentación:** Interfaz del Punto de Marcación (Punto de marcación / Pantalla de Marcaje)
- **Definición de Componentes y Flujo Funcional:**
  ...
  - **Módulo de Confirmación y Retroalimentación:**
    - **Panel de Resultado de Marcación:** Al terminar el proceso, despliega en pantalla la información formateada:
      ...
      - Hora exacta de registro y el Estado de Cumplimiento determinado (_Puntual_, _Retraso_, _Anticipada_).
      - Método utilizado (_Facial_ o _QR_).
...
- **Definición de Componentes y Flujo Funcional:**
  ...
  - **Ventana Emergente (Modal)** Resolución de Inconsistencia**:**
    - **Campos de Edición:**
      ...
      - Desplegable de Nuevo Estado de Cumplimiento (_Puntual_, _Retraso_, etc.).
      - Área de texto obligatoria Observación / Justificación.
    - **Controles de Acción:**
      - **Botón** Guardar Resolución**:** Verifica la presencia de la observación justificativa, actualiza la tabla de asistencias e inserta el registro inmutable de auditoría en asistencias_pendientes.
...
- **Definición de Componentes y Flujo Funcional:**
  - **Panel de Filtros Avanzados (Barra Superior):**
    ...
    - Selector desplegable de Estado de Cumplimiento (_Puntual_, _Retraso_, _Anticipada_, _Incompleto_).
  ...
  - **Tabla de Resultados del Historial:**
    ...
    - Muestra un mensaje informativo en caso de que la búsqueda no arroje coincidencias ("_No se encontraron registros de asistencia para los filtros especificados_").
  - **Barra de Navegación / Paginador:**
...
- **Definición de Componentes y Flujo Funcional:**
  - **Formulario de Parametrización del Reporte:**
    ...
    - Selector del Formato de Exportación (Opciones: _PDF_ / _CSV-Excel_).
  - **Controles de Acción:**
  ...
  - **Manejo de Excepciones:**
    - Alerta en pantalla si la consulta no devuelve datos para el período o filtros seleccionados ("_No existen registros disponibles para generar el reporte en el rango especificado_").
